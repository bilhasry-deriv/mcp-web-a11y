...
class WebA11yServer {
    ...
    async handleColorBlindSimulation(request) {
        if (!request.params.arguments ||
            typeof request.params.arguments.url !== 'string' ||
            typeof request.params.arguments.type !== 'string') {
            throw new McpError(ErrorCode.InvalidParams, 'URL and type parameters are required');
        }
        const args = {
        ...
        try {
            ...
            await page.evaluate((type) => {
                ...
                window.simulate = function (rgb, type) {
            ...
            const outputPath = join('/Users/bilhasryramadhony/Documents/Exploration/mcp-web-a11y/output', args.outputPath || `colorblind_${args.type}.png`);
    ...
    async handleAccessibilityCheck(request) {
